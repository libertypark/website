...
const DocumentsPage = () => {
  const documents = [
    ...
    { id: 4, title: "CC&Rs and Architectural Control Standards", description: "Covenants, Conditions, & Restrictions and Architectural Control Standards.", date: "2024-03-10", link: "/ccrs-architectural-standards.pdf" },
    { id: 5, title: "Community Handbook", description: "A guide to living in Liberty Park, including rules and resources.", date: "2024-01-01", link: "/community-handbook.pdf" }, // New document entry
  ];
